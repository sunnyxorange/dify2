...
class FeatureModel(BaseModel):
    ...
    tenant_registration_enabled: bool = False
    tenant_sso_enabled: bool = False
    tenant_custom_domain_enabled: bool = False
...
class FeatureService:
    ...
    def _fulfill_params_from_env(cls, features: FeatureModel):
        ...
        features.multi_tenant_enabled = dify_config.MULTI_TENANT_ENABLED
        features.tenant_registration_enabled = dify_config.TENANT_REGISTRATION_ENABLED
        features.tenant_sso_enabled = dify_config.TENANT_SSO_ENABLED
        features.tenant_custom_domain_enabled = dify_config.TENANT_CUSTOM_DOMAIN_ENABLED
    ...
    def _fulfill_params_from_enterprise(cls, features):
        ...
        if "tenant_sso_enabled" in enterprise_info:
            features.tenant_sso_enabled = enterprise_info["tenant_sso_enabled"]
        if "tenant_custom_domain_enabled" in enterprise_info:
            features.tenant_custom_domain_enabled = enterprise_info["tenant_custom_domain_enabled"]
